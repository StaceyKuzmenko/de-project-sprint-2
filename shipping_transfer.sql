DROP 
  TABLE IF EXISTS public.shipping_transfer;
...
INSERT INTO public.shipping_transfer (
  id, transfer_type, transfer_model, 
  shipping_transfer_rate
) 
SELECT 
  DISTINCT nextval('shipping_transfer_sequence'):: BIGINT as id, 
  split_part(
    shipping_transfer_description, ':', 
    1
  ):: varchar(2) as transfer_type, 
  split_part(
    shipping_transfer_description, ':', 
    2
  ):: varchar(9) as transfer_model, 
  shipping_transfer_rate 
FROM 
  public.shipping 
GROUP BY 
